...
#[derive(Debug)]
pub struct WaifuHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WaifuHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WaifuHub processing");
    
    let mut processor = WaifuHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WaifuHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WaifuHubProcessor::new(false);
